...
(function ($, window, document, undefined) {
    ...
    $.extend(Wickedpicker.prototype, {
        ...
        parseHours: function (hours) {
            return (this.options.twentyFour === false) ? ((hours + 11) % 12) + 1 : (hours < 10) ? '00' + hours : hours;
        },
